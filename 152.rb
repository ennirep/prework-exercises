...
add_three_numbers1 = add_three_numbers(3, 2, 7)

puts add_three_numbers1

#The code expected 3 things to be input but was only given 1. The numbers were entered in the wrong section of the code